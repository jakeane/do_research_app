  ...
  return (
    <div>
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Jack
        Keane.
      </p>{" "}
      <p>
        Jack Keane is committed to ensuring that the app is as useful and
      ...
      <p>
        The DoResearch app stores and processes personal data that you have
        ...
        features and it could mean that the DoResearch app won’t work properly
        or at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Jack Keane will
        ...
        Wi-Fi, or provided by your mobile network provider, but Jack Keane
      ...
      <p>
        Along the same lines, Jack Keane cannot always take responsibility for
        ...
        avail the Service, Jack Keane cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to Jack Keane’s responsibility for your use of the app,
        ...
        make it available to you. Jack Keane accepts no liability for any loss,
      ...
      <p>
        ...
        to keep using the app. Jack Keane does not promise that it will always
      ...
      <p>These terms and conditions are effective as of 2020-06-22</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at jakeane13@gmail.com.
      </p>{" "}
      <p>
